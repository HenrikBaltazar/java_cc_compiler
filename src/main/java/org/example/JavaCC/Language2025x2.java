...
semantico.inicioVetorAtribuicao();
    vetor();
semantico.fimVetorAtribuicao();
...
semantico.saidaConstLiteral(id);
  ...
  final public void vetor() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACKET:{
      jj_consume_token(LBRACKET);
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NUM:{
        // CASO 1: OTIMIZAÇÃO (Índice Constante, ex: v[3])
                    t = jj_consume_token(NUM);
semantico.vetorConstante(t);
        break;
        }
      case TRUE:
      case FALSE:
...
consumeUntil(comandoRecSet, e, "lista de comandos");
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x100,0x0,0x0,0xf000,0xe600000,0x0,0x0,0x0,0x80000000,0x80000000,0x870800,0x870800,0x0,0xe000000,0xe600000,0x0,0x30000000,0x30000000,0x0,0x0,0x0,0x0,0x0,0xe600000,0x100000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x800000,0x0,0x800000,0x2,0x0,0x0,0x2,0x2,0x20,0x0,0x0,0x0,0x0,0x2,0x800000,0x900080,0x20,0xe0800,0xe0800,0x200600,0x200600,0x417000,0x417000,0x8000,0x900080,0x0,};
	}
